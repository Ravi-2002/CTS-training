...
class Form extends React.Component {
    ...
    onChangeCtrl = (e) => {
      ...
      if (type === "checkbox") {
        ...
        const updatedStores = checked
          ? [...this.state.Store, selectedStore]
          : this.state.Store.filter((store) => store !== selectedStore);
  
        this.setState({ Store: updatedStores });
      } else {
    ...
    onSubmit=(e)=> {
      ...
      const {  productId, productName, productCost, productOnline,productCategory,...Store } = this.state;
    ...
    render(
      ...
      const {  productId, productName, productCost, productOnline,productCategory,Store,editId } = this.state;
